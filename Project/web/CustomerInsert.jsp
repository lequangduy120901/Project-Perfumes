            ...
            <div class="content-agile2">
                <form action="#" method="post">
                    <div class="form-control w3layouts"> 
                        <input type="text" id="name" name="cname" placeholder="Full Name" title="Please enter your name" required="">
                    </div>
                    ...
                    <div class="form-control w3layouts"> 
                        <input type="text" id="address" name="add" placeholder="Address" title="Please enter your address" required="">
                    </div>
